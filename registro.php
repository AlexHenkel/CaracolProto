                        ...
                        <div class="form-hidden">
                            <span class="input input--fumi">
                                ...
                                <label class="input__label input__label--fumi" for="input-23">
                                    ...
                                    <span class="input__label-content input__label-content--fumi">Ingresa tu nombre</span>
                                </label>
                            </span>
                            <span class="input input--fumi">
                                <input class="input__field input__field--fumi" type="text" id="input-23" />
                                <label class="input__label input__label--fumi" for="input-23">
                                    ...
                                    <span class="input__label-content input__label-content--fumi">Ingresa tu dirección</span>
                                </label>
                            </span>
                            <span class="input input--fumi">
                                <input class="input__field input__field--fumi" type="text" id="input-23" />
                            ...
                            <button type="submit" class="btn-fill sign-up-btn">Registrarse</button>
                        </div>
                    </form>
